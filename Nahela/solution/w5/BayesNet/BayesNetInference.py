...
if __name__ == "__main__":
    ...
    alg_name = 'InferenceByEnumeration' # inference algorithm={InferenceByEnumeration,RejectionSampling}
    file_name = 'BayesNet/d-c.txt' # your_config_file.txt, e.g., config-alarm.txt
    prob_query = 'P(BloodPressure|Age=3,Outcome=0)' # query, e.g., P(B|J=true,M=true)
